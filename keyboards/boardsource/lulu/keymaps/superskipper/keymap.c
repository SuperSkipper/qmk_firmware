...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_PSTE,  KC_COPY,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_DEL,
                          KC_LGUI,    KC_LALT, LOWER, KC_BSPC,  KC_SPC,   RAISE,   KC_ENT, KC_DEL
),
/* GAME
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
 ...
 [_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                   _______, _______, KC_MINS, KC_PLUS, _______, _______,
  _______, _______, _______, _______, _______, _______,                   _______, KC_LPRN, KC_LCBR, KC_RCBR, KC_RPRN, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, _______,
